...
def main():
    files = ["/home/dom/projects/chloroplasts/hook_system/processor/antlr/Factorial.java", "/home/dom/projects/chloroplasts/hook_system/processor/antlr/LeTest.java"]
    process(files)
